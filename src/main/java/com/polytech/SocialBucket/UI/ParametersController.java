...
public class ParametersController {
    ...
    private void handleModifySecretCode() {
        ...
        // You can use currentCodeTextField.getText() and newCodeTextField.getText() to get the entered values
    ...
    private void modifySecretCode() {
        ...
        // Validate if currentSecretCode and newSecretCode are not empty before proceeding
